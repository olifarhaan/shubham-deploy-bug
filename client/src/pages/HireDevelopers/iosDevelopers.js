...
import { IosDevelopersFaqs } from "../../components/faqData.js";
    ...
    <div className="min-h-screen flex flex-col items-center justify-center py-10 mt-20">
      <div className="bg-white py-5 px-10 w-full">
        <div className="flex flex-col lg:flex-row items-center lg:space-x-16 ml-10 mt-10">
          ...
          <div className="flex justify-center  mb-12 lg:mb-0 mt-5">
            <img
              src="\assets\images\headerSection\hireiOSDev\img1.png"
      ...
      <div className="text-center mb-5 mt-20">
        ...
        <p className="sm:text-base md:text-lg lg:text-xl text-gray-600 font-semibold mt-4 max-w-6xl mx-auto">
          When building and deploying iOS applications, we lead with the list of
          trusted iOS development companies. Hire iOS experts from Ayanshtech
          for fully functional range of applications.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">iOS app designing</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">App planning and consultation</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Custom iOS app development</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">iOS app QA and Testing</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">App maintenance and support</p>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <img
              ...
              className="w-14 h-14"
            />
            <p className="text-lg">Industry-specific app development</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/3 p-4">
            <img
              src="\assets\images\headerSection\hireiOSDev\img2.png"
          ...
          <div className=" md:w-1/2 lg:w-3/4 p-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  We have a team of iOS developers who have built and deployed
                  iOS applications for prominent sectors regardless of your
                  business niche.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Our developers are up-to-date with the latest knowledge,
                  trends, and tools running in the market.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Our developers have developed a range of applications for
                  startups to big MNCs.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-lg">
                  Whatever add-ons or changes occur in the project, the team
      ...
      <div className="max-w-3xl mx-auto p-6 py-20 w-full ">
        ...
        {IosDevelopersFaqs.map((faq, index) => (
